...
class Parser:
    ...
    def find_matching_statement(self):
        ...
        for statement in self.statements:
            ...
            return schemas.CreateStatement(statement=statement, plural_name=name)
        return None
    ...
    def parse(self):
        ...
        return schemas.Table(columns=columns,
                             names = schemas.Names(singular_name=self.statement.names.singular_name,
    ...
    def _is_nullable(line: str) -> bool:
        return False if "NOT NULL" in line else True
